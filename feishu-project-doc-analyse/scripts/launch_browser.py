...
Default URL: https://<tenant>.feishu.cn/drive/home/
...
if not os.environ.get("DISPLAY"):
    ...
    for xauth_path in [
        "/run/user/1001/.mutter-Xwaylandauth.73GKP3",
...
def main():
    ...
    parser.add_argument("url", nargs="?", default="https://<tenant>.feishu.cn/drive/home/")
    ...
    with sync_playwright() as p:
        ...
        print("Please log in on the browser window.")
        write_result({
            "status": "ready",
            "url": page.url,
            "message": "Please login on the browser window"
        })
